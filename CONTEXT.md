...
| agent-profile | Branded agent profile card + portrait | OpenAI GPT Image 2 (`$OPENAI_API_KEY` env) |
| yad2-import | Structured property list from Yad2 | Apify MCP (Yad2 scraper) |

## Phase 2 - Marketing
| Workflow | Produces | Engine |
|---|---|---|
| photo-enhance | Staged/enhanced property images | OpenAI GPT Image 2 (edit + inpaint) |
...
| social-posts | FB/IG post pack with virality scores | OpenAI GPT Image 2 + LLM virality estimate |
