...
| 02-declutter | Remove clutter / background / personal items | OpenAI `images.edit` (gpt-image-2, multipart) |
| 03-stage | Virtually furnish empty rooms in brand style | OpenAI `images.edit` (gpt-image-2, multipart) |
