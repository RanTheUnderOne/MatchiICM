...
| 02-declutter | Remove clutter / background / personal items | OpenAI `generate_image` (DALL-E 3 edit mode) |
| 03-stage | Virtually furnish empty rooms in brand style | OpenAI `generate_image` (DALL-E 3) |
